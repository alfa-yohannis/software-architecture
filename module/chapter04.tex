...
\begin{enumerate}
  \item Menjelaskan peran port dan adapter serta arah \textit{dependency} yang
...
menyelesaikan persoalan tersebut dengan membalik arah \textit{dependency}. Logika
...
tengah, dan seluruh panah \textit{dependency} menunjuk ke dalam. Karena itu tidak ada
...
sedangkan arah \textit{dependency}-nya sama-sama menunjuk ke dalam.
...
sebab di situlah \textit{dependency} pada teknologi paling sering bocor.
...
itulah yang membalik arah \textit{dependency}-nya.
...
\textit{Dependency} terhadap teknologi karena itu terkumpul di satu tempat, dan tidak
tersebar.
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{|l|X|X|}
    ...
    \hline
    Arah \textit{dependency} & Ke bawah, menuju penyimpanan & Ke dalam, menuju logika inti \\
    \hline
...
penyimpanan. Ports and adapters membalik arah \textit{dependency} yang berlaku pada
...
Seluruh panah \textit{dependency} karena itu menunjuk ke dalam.
...
modul standar. Jelaskan mengapa impor tersebut tidak melanggar klaim.
