...
membuat waktu siap tiga kali lebih cepat, dan selisihnya lebih besar daripada
...
\begin{enumerate}
  ...
  \item Salin \berkas{sources/chapter05/plugin_riwayat.py} beserta manifesnya
    menjadi \texttt{plugin\_pajak.py}, lalu ubah nama dan perintahnya.
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{|X|l|}
    ...
    Baris inti & 100 \\
    \hline
    Baris seluruh \textit{plugin} & 65 \\
    \hline
    Bagian \textit{plugin} & 39 persen \\
    \hline
  \end{tabularx}
\end{table}
...
\begin{enumerate}
  \item Baca \berkas{sources/chapter05/plugin_rusak.py}, lalu tunjukkan baris
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{|X|l|}
    ...
    \hline
    \textit{Range} di dalam jalur lambat & 1,0883 ms \\
    \hline
...
lebih kecil daripada selisihnya, dan pencacahan per putaran menegaskannya
dengan angka 100 dari 100. Selisih yang seperti inilah yang layak dilaporkan.
