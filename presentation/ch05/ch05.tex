...
\begin{document}
	...
	\begin{frame}
		...
		\centering{\includegraphics[width=9cm,height=5cm]{../../images/Layering Architecture}
	}
	\end{frame}
	...
	\begin{frame}
		...
		%\textbf{\color{blue} Glenny: pemanggilan photo salah atau gambar tidak ada}
		\includegraphics[width=5cm,height=3.5cm]{../../images/Software Architecture Pattern}
	\end{frame}
	...
	\begin{frame}
		\frametitle{Design Patterns}
		%\textbf{\color{blue} Glenny: pemanggilan photo salah atau gambar tidak ada}
		\includegraphics[width=9cm,height=5cm]{../../images/contoh}
