...
\end{lstlisting}
  ...
  \vspace{8pt}
  {\small Satu aplikasi, empat varian, tiga masalah berbeda. Logika bisnisnya
  dipakai bersama dari \texttt{domain.py}, sehingga perbandingannya hanya
  menguji susunan komponennya.}
\end{frame}
